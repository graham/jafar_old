/* Jafar Javascript Client */

var build_jafar_client = function(cb_build, cached_raw) {
    var url = '';
	...
	for(var index in d) {
	    ...
	    var results = genie.dig_set(
                the_client, chunks, call_url(details), 
                { 
                    'def':function() { 
                        return new a_proxy(); 
                    }
